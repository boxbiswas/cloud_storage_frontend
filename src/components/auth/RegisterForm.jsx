  ...
  return (
    <div className="w-full max-w-[420px] bg-white rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] p-10">
      <div className="mb-10">
        ...
        <h1 className="font-display font-bold text-3xl tracking-tight text-slate-900">Create an account</h1>
      </div>

      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label className="block font-body text-[11px] font-semibold uppercase tracking-widest text-slate-500 mb-2">Full Name</label>
          <input 
            type="text" 
            value={name}
      ...
      <div className="mt-8 flex justify-center">
        <p className="font-body text-sm text-slate-500">
          ...
          <Link to="/login" className="font-semibold text-azure-600 hover:text-azure-700 transition-colors">
            Log in
          </Link>
        </p>
      </div>
